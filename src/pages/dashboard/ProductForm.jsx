...
const [imgLoading,setImgLoading]=useState(false);
  ...
  const handleFileUplaod = async(event) =>{
   ...
   const res = await fetch("https://api.cloudinary.com/v1_1/dvt5ubo1q/image/upload",{
    method:"POST",
    body:data
   })
    ...
    <div className="flex flex-col items-center justify-center pt-5 pb-6">
     {!imgLoading? <svg
      ...
      >
        ...
        />
      </svg>: <div className="w-8 h-8 mb-4 border-4 border-green-500 border-dashed rounded-full animate-spin"></div>} 
  ...
  selectedFile && (
    ...
    <img className=" max-w-[150px] max-h-[150px]" src={productimg} alt=""  />
