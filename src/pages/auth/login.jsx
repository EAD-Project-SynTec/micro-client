                ...
                <div className="max-w-6xl px-0 mx-auto lg:px-6">
                    <div className="flex flex-col items-center h-full md:flex-row">
                        <div
                            ...
                            <div className="z-10 w-full p-10 bg-gray-200 dark:bg-gray-900 h-100">
                                ...
                                <form action="" className="mt-6">
                                    ...
                                    <button
                                        className="w-full px-4 py-3 mt-6 font-semibold text-gray-200 bg-green-600 rounded-lg hover:text-gray-700 hover:bg-green-700 "
