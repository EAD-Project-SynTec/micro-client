...
<div className='rounded-full bg-secondary w-[220px] '>
    <div className='flex justify-between items-center p-2 '>
        <IconButton color="gray" className="bg-green-500 text-white p-4 disabled:bg-gray-400 rounded-full text-3xl font-normal" disabled={disableDecrement} onClick={handleDecrement}>-</IconButton>
        <span className=' text-gray-800 font-medium '>{quantity} kg</span>
        <IconButton color="gray" className="bg-green-500 text-white p-4 disabled:bg-gray-400 rounded-full text-2xl font-normal" disabled={disableIncrement} onClick={handleIncrement}>+</IconButton>
    </div>
</div>
    );
};
